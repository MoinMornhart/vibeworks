...
export const NOTIFY_EVENTS = ["taskDue", "accessRequest", "issueClosed", "ciFailed", "checkAlert", "appError", "community", "team", "gitFailed", "siteDown", "renewal", "suggestions", "passwordAge", "updated"] as const;
