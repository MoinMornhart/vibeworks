...
const de = {
  ...
  centerLink: "Alle Meldungen ansehen, filtern und Regeln festlegen →",
  channelsTitle: "Wohin zusätzlich?",
  urgent: "Kritisches mit höchster Priorität",
  urgentHint: "Neue App-Fehler, eine ausgefallene Seite und Geheimnisse im Repository kommen dann auch bei „Nicht stören“ durch – in der ntfy-App für dieses Thema erlauben.",
  channelOn: "aktiv",
  channelOff: "aus",
  ...
  switches: {
    ...
    issueComment: "Jemand antwortet im Issue einer deiner Aufgaben",
    issueImported: "Aus einem neuen Issue im Repository wurde eine Aufgabe",
  ...
  events: {
    ...
    issueComment: { title: "{author} antwortet: {title}", message: "{text}" },
    issueImported: { title: "Neue Aufgabe aus Issue #{number}: {title}", message: "Von @{author} in „{project}“.{locked}", locked: " Für die KI gesperrt, bis du sie freigibst." },
    ...
    codeCopyFailed: { title: "Code-Netz und Code-Suche: Kopie für {project} ließ sich nicht holen" },
    importFailed: { title: "Git-Import scheitert: {host}", message: "{error}" },
    tokenProblem: { title: "Git-Zugang braucht Aufmerksamkeit: {host}", invalid: "Der Token gilt nicht mehr: {error}", missing: "Dem Token fehlen Rechte: {list}. Bitte einen Token mit diesen Rechten eintragen." },
    ...
    weeklyReport: {
      title: "Wochenbericht KW {week}",
      done: plural("✅ {n} Aufgabe erledigt", "✅ {n} Aufgaben erledigt"),
      runs: plural("🤖 {n} Workflow-Durchlauf abgeschlossen", "🤖 {n} Workflow-Durchläufe abgeschlossen"),
      proven: "{proven} von {steps} Schritten belegt",
      errors: plural("🐞 {n} neuer Fehler", "🐞 {n} neue Fehler"),
...
const en: Shape<typeof de> = {
  ...
  centerLink: "See all notifications, filter them and set rules →",
  channelsTitle: "Where else?",
  urgent: "Critical ones with top priority",
  urgentHint: "New app errors, a site going down and secrets in the repository then get through “Do not disturb” too – allow it for this topic in the ntfy app.",
  channelOn: "on",
  channelOff: "off",
  ...
  switches: {
    ...
    issueComment: "Someone replies in the issue of one of your tasks",
    issueImported: "A new issue in the repository became a task",
  ...
  events: {
    ...
    issueComment: { title: "{author} replied: {title}", message: "{text}" },
    issueImported: { title: "New task from issue #{number}: {title}", message: "By @{author} in “{project}”.{locked}", locked: " Locked for the AI until you release it." },
    ...
    codeCopyFailed: { title: "Code network and search: the copy for {project} could not be fetched" },
    importFailed: { title: "Git import failing: {host}", message: "{error}" },
    tokenProblem: { title: "Git access needs attention: {host}", invalid: "The token is no longer valid: {error}", missing: "The token lacks permissions: {list}. Please add a token with these permissions." },
    ...
    weeklyReport: {
      ...
      done: plural("✅ {n} task completed", "✅ {n} tasks completed"),
      runs: plural("🤖 {n} workflow run finished", "🤖 {n} workflow runs finished"),
      proven: "{proven} of {steps} steps with evidence",
      errors: plural("🐞 {n} new error", "🐞 {n} new errors"),
