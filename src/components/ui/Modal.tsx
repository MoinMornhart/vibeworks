...
export function Modal({
  ...
  useEffect(() => {
    ...
    (focusables().find((el) => el.hasAttribute("autofocus")) ?? focusables()[0] ?? node)?.focus();
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-4" onMouseDown={(e) => e.target === e.currentTarget && onClose()}>
