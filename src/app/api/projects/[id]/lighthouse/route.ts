...
import { refreshLighthouse, serializeLighthouse, setLighthouse, startLighthouse } from "@/lib/git/lighthouse";
...
export const POST = route<Params>(async (req, { params }) => {
  ...
  const { project } = await requireProject(user.id, id, body.action === "enable" || body.action === "disable" ? "OWNER" : "git.sync");
